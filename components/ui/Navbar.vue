              ...
              <span class="flex items-center">
                ...
                <div class="hidden sm:ml-6 sm:flex sm:items-center">
                    ...
                    <button
                        ...
                        class="flex items-center justify-center rounded-full text-gray-500 hover:text-gray-700 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:text-gray-300 dark:hover:text-white"
                        style="height: 24px;width: 24px"
                        :title="themeStore.isDark ? t('navbar.switchToLightMode') : t('navbar.switchToDarkMode')"
                    >
                        <!-- Sun icon for dark mode -->
                        <NuxtIcon :name="themeStore.isDark ? 'heroicons:moon-solid' : 'heroicons:sun-solid'"/>
                    </button>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <div class="h-8 w-8 rounded-full overflow-hidden">
                                    ...
                                    <div v-else
                                         class="h-full w-full bg-indigo-100 flex items-center justify-center text-indigo-800 font-semibold">
                                        {{ userInitials }}
                                    </div>
                                </div>
                            </button>
            ...
            <div class="pt-2 pb-3 space-y-1">
                ...
                >
                    <div class="flex items-center">
                        <span v-if="$route.path === '/dashboard'"
                              class="w-2 h-2 bg-indigo-500 rounded-full mr-2"></span>
                        {{ t('navbar.dashboard') }}
                    </div>
                </NuxtLink>
                <NuxtLink
