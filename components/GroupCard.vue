                ...
                <div class="flex -space-x-2 overflow-hidden">
                    <template v-for="(member, index) in displayMembers" :key="member.id">
                        ...
                        >
                            ...
                            <div v-else
                                 class="h-full w-full flex items-center justify-center bg-indigo-100 text-indigo-800 font-semibold text-xs">
                    ...
                    <template v-for="(member, index) in displayMembers" :key="member.id">
                        ...
                        >
                            <img v-if="member.avatar" :src="member.avatar" alt="Member avatar"
                                 class="h-full w-full object-cover"/>
                            <div v-else
                                 class="h-full w-full flex items-center justify-center bg-indigo-100 text-indigo-800 font-semibold text-sm">
                                {{ getMemberInitials(member) }}
                            </div>
                        </div>
                    </template>
