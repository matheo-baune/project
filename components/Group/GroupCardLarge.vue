<template>
  <div class="group-card-large overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer dark:bg-gray-800 dark:border-gray-700" @click="$emit('click', group)">
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex -space-x-2 overflow-hidden">
          <template v-for="(member, index) in displayMembers" :key="member.id">
            <div class="inline-block h-10 w-10 rounded-full overflow-hidden" :title="member.firstname">
          ...
          <div v-if="group.members.length > maxDisplayMembers" class="inline-block h-10 w-10 rounded-full bg-gray-200 flex items-center justify-center text-gray-600 font-semibold text-sm" :title="remainingMembersNames">
