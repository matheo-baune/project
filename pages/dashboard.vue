    ...
    <div class="min-h-screen dark:bg-gray-900 transition-colors duration-200">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 dark:text-white">
            ...
            <div v-else-if="groups.length === 0"
                 class="bg-white shadow rounded-lg p-8 text-center dark:bg-gray-800 dark:border dark:border-gray-700">
        ...
        <div v-if="showCreateGroupModal || showEditGroupModal" class="fixed z-10 inset-0 overflow-y-auto"
                                    ...
                                    <form @submit.prevent="handleSubmitGroup">
                                            ...
                                            <div class="mt-1">
                                                <input
                                                    ...
                                                    :class="[
                                                        ...
                                                        formErrors.includes('Le nom du groupe est requis') 
                                                            ? 'border-red-300 text-red-900 placeholder-red-300 focus:ring-red-500 focus:border-red-500' 
                                                            : 'border-gray-300'
                                                    ]"
                                                    placeholder="Family, Friends, Colleagues..."
                                                />
                                                <p v-if="formErrors.includes('Le nom du groupe est requis')" class="mt-1 text-sm text-red-600">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="mt-1">
                                                ...
                                                />
                                                <div v-if="groupForm.background" class="mt-2">
                                                    <p class="text-sm font-medium text-gray-700 mb-1">Background Preview:</p>
                                                    <img :src="groupForm.background" alt="Background preview" class="h-32 w-full object-cover border border-gray-200 rounded-md" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="mt-1">
                                                <div v-for="(member, index) in groupForm.members" :key="index"
                                                     class="flex w-full mb-2">
                                                    <div v-if="userStore.currentUser?.id !== member.id">
                                                        <input
                                                            type="text"
...
const handleSubmitGroup = async () => {
    ...
    try {
        ...
        const validMembers = groupForm.value.members.filter(member => member.username && member.email);
